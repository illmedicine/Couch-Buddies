  ...
  return (
    <div className="min-h-screen bg-surface-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 pb-16">
        ...
        <motion.div className="grid grid-cols-1 lg:grid-cols-2 gap-10" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <div className="rounded-2xl overflow-hidden bg-surface-800 border border-white/5">
            <div className="aspect-square">
              <img src={product.images?.[0] || PLACEHOLDER_IMG} alt={product.name} className="w-full h-full object-cover" referrerPolicy="no-referrer" onError={(e) => { if (!e.target.dataset.fallback) { e.target.dataset.fallback = '1'; e.target.src = PLACEHOLDER_IMG } }} />
            </div>
          </div>
